...
careful. So it is important to learn how to use them. This course will give you
some pointers on how to integrate LLMs into your workflow. All of the exercises
can and should be tackled using LLMs.
...
your machine and expect me to debug it to get it to run, there is no excuse
for this, especially in the age of LLMs.

At the end of each chapter, there are exercises that should help you solidify
your knowledge. These are not graded, and there purely for you to learn more.
